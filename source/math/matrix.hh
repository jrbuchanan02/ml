...
// allow multiple-argument indexing operators when they exist.
        ...
        template <CONCEPT_NAMESPACE Floating W = V, CONCEPT_NAMESPACE Floating X = decltype(V{0} + W{0})>
        ...
        /**
         * @brief Gets this in reduced row echelon form. I have not mathematically
         * proven that this algorithm is correct, but I have not seen any indication
         * that it performs anything dubious.
         * @note It solves it more like a human would tho, so there's perhaps some
        ...
        /**
         * @brief Attempts to find the inverse of this matrix using the superaugmented
         * matrix technique (augmenting this with the appropriate identity matrix
         * and reducing to echelon form). 
         * @note While this technique works, the only
         * time this function indicates that the inverse cannot be found is if 
         * the matrix is not square and there are other conditions for no inverse
         * to exist.
         ...
         * cannot differentiate say 0.1 and the nearest finite linear combination
         * of powers of 2. So, you may find that A * A.inverse() != identity(A.rowCount());
         * but the diference between A * A.inverse() and identity(A.rowCount()) should
         * be markedly small.
